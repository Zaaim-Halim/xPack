...
//!
//! Uninstalling removes the installation root and nothing else. xPack does not
//! know where an application keeps user data — that path is chosen by the
...
pub use installer::{InstallOptions, Installed, Installer};
